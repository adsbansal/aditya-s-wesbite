      ...
      <div className="text-slate-300 sm:px-16 sm:mx-16">
        <FadeIn transitionDuration={600} delay={80}>
          <div className="py-4 my-4">
              <h1 className="mt-6 mb-5 font-semibold text-xl underline">Currently:</h1>
          ...
          <div className="py-4 my-4">
              <h1 className="mt-6 mb-5 font-semibold text-xl underline">Projects I've worked on:</h1>
              <div className="px-1 mx-1">
                  <h3 className="font text-base my-4">
                      → 
                      <a href="https://github.com/adsbansal/buildspace-dao-starter]" className="ml-2 hover:underline">Decentralized Autonomous Organization App</a>
