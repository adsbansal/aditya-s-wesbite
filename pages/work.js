      ...
      <div className="text-slate-300 sm:px-16 sm:mx-16">
        <FadeIn transitionDuration={600} delay={80}>
          <div className="py-4 my-4">
              ...
              <p>→ Working on an <a href='https://www.linkedin.com/company/vara-climate/?trk=public_profile_topcard-current-company' style='color: blue; text-decoration: underline;'>environmental compliance software</a> on the weekends!</p>
          </div>
